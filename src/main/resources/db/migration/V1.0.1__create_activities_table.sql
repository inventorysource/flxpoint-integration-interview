create schema if not exists flxpoint;

CREATE TABLE IF NOT EXISTS flxpoint.activity (
    id LONG PRIMARY KEY,
    title VARCHAR(255),
    price FLOAT,
    currency VARCHAR(16),
...
INSERT INTO flxpoint.activity (id, title, price, currency, rating, special_offer, supplier_id) VALUES
